<x-filament::page>
    ...
    '/admin/blok-produksi' => 'Blok Produksi',
    '#' => 'Data Hasil Produksi',
    ]" />
    ...
    <div class="space-y-6">
        ...
        <x-page-header
            ...
            subtitle="Blok {{ $blokId }} - Kelola data hasil produksi"
            :back-url="route('filament.admin.pages.blok-produksi', ['afdeling_id' => $afdeling_id])" />
