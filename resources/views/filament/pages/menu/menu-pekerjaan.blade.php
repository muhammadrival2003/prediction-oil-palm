<x-filament-panels::page>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 p-4">
        <!-- Card Rencana Pekerjaan -->
        <a href="{{ route('filament.admin.resources.many-gawangan-manuals.index') }}"
            class="group relative block rounded-xl bg-white dark:bg-gray-800 p-6 transition-all 
                  ...
                  shadow-sm hover:border-emerald-500 dark:hover:border-emerald-400">
            ...
            <div class="flex items-start justify-between">
                ...
                <div class="space-y-3">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Chemis Piringan Pokok / Pasar Pikul
                    </p>
                </div>
        ...
        <a href="{{ route('filament.admin.pages.blok-pemupukan') }}"
            class="group relative block rounded-xl bg-white dark:bg-gray-800 p-6 transition-all 
                  hover:shadow-lg hover:-translate-y-1 border border-gray-200 dark:border-gray-700
                  shadow-sm hover:border-emerald-500 dark:hover:border-emerald-400">
